...
**STEP 1 – Resource Group Create Karna**:
...
**STEP 2 – Virtual Network Create Karna**:
...
- Public IP: None (IMPORTANT — direct internet access nahi denge).
...
For simplicity:
- Let’s create a temporary public IP for VM1 for setup, baad mein remove kar dena.
...
**STEP 6 – Install IIS on Both VMs**:
...
**STEP 8 – Backend Pool Configuration**:

Load Balancer → Backend Pools → Add
...
**STEP 9 – Health Probe Configuration**:
...
**STEP 10 – Load Balancing Rule Create Karna**:
...
Now let’s deeply understand what happens when user browser open karta hai:
...
**Step 2**:
- DNS resolve hota hai → Load Balancer public IP.
...
### Problem Statement – NAT Rule Kyun Zaroori Hai?
